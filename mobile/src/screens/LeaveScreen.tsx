...
import { View, Text, TouchableOpacity, ScrollView, TextInput, Modal, Image, Platform, Alert } from 'react-native';
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="bg-primary py-6 px-4">
        <View className="flex-row items-center">
          ...
          <View>
            <Text className="text-white text-xl font-bold">Pengajuan Izin</Text>
            <Text className="text-white opacity-90">{user?.nama || 'Loading...'}</Text>
          </View>
        </View>
      </View>
        ...
        <View className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          ...
          <View className="mb-6">
            ...
            <Text className={`text-sm mt-2 ${
              description.length < 10 && description.length > 0 ? 'text-red-500' : 'text-gray-500'
            }`}>
              ...
              {leaveTypes.map((type) => (
                <TouchableOpacity
                  ...
                  className={`flex-row items-center p-4 rounded-xl mb-2 ${
                    leaveType === type.label ? 'bg-primary' : 'bg-gray-100'
                  }`}
                  onPress={() => {
                ...
                >
                  ...
                  <Text className={`text-lg font-semibold ${
                    leaveType === type.label ? 'text-white' : 'text-gray-800'
                  }`}>
                    {type.label}
                  </Text>
                </TouchableOpacity>
